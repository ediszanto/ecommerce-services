...
public class Test extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -2839110887667971262L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Test\",\"namespace\":\"test\",\"fields\":[{\"name\":\"userId\",\"type\":\"string\"}]}");
   ...
   */
  public Test(java.lang.CharSequence userId) {
    this.userId = userId;
  }
   ...
   */
  public static test.Test.Builder newBuilder() {
    return new test.Test.Builder();
  }
   ...
   * @return A new Test RecordBuilder
   */
  public static test.Test.Builder newBuilder(test.Test.Builder other) {
    if (other == null) {
      return new test.Test.Builder();
    } else {
      return new test.Test.Builder(other);
    }
  }
   ...
   * @return A new Test RecordBuilder
   */
  public static test.Test.Builder newBuilder(test.Test other) {
    if (other == null) {
      return new test.Test.Builder();
    } else {
      return new test.Test.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Test>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(test.Test.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(test.Test other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.userId)) {
        this.userId = data().deepCopy(fields()[0].schema(), other.userId);
    ...
    /**
      ...
      * @return This builder.
      */
    public test.Test.Builder setUserId(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public test.Test.Builder clearUserId() {
      userId = null;
